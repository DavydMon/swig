 ...
 */
#ifndef __PJMEDIA_TRANSPORT_ADAPTER_NACK_H__
#define __PJMEDIA_TRANSPORT_ADAPTER_NACK_H__
 ...
 * @brief ACK/NACK based feedback transport adapter.
 * @{
 *
 * This describes a implementation of ACK/NACK transport adapter, similar to
 ...
 */
PJ_DECL(pj_status_t) pjmedia_nack_adapter_create(pjsip_endpoint *sip_endpt,
							pjmedia_endpt *endpt,
					        const char *name,
